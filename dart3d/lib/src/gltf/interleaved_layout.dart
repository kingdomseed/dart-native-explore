// Ported from flutter_scene 0.23.0 `lib/src/geometry/interleaved_layout.dart`
// (MIT, copyright Brandon DeRosier). Verbatim except the constants import
// (upstream `importer/constants.dart` → `gltf/constants.dart` here).
