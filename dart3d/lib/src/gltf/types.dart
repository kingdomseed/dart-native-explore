// Ported from flutter_scene 0.23.0 `lib/src/importer/src/gltf/types.dart`
// (MIT, copyright Brandon DeRosier). Verbatim except the doc comment's
// `flutter_scene` reference.

import 'package:vector_math/vector_math.dart';

import 'warnings.dart';

/// In-memory representation of the parts of glTF 2.0 that dart3d
...
class GltfMeshPrimitive {
  ...
  /// Primitive topology. 4 = TRIANGLES (the only mode dart3d supports).
  final int mode;
