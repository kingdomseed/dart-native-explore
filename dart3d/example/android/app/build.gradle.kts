...
android {
    namespace = "com.jasonholtdigital.dart3d_example"
    ...
    defaultConfig {
        ...
        applicationId = "com.jasonholtdigital.dart3d_example"
        // You can update the following values to match your application needs.
        // dart3d requires 26 (Filament/Jolt floor); dn's floor is 24.
        minSdk = 26
    ...
    packaging {
        resources {
            // jolt-jni ships the same compute shaders in both the JVM
            // API jar and the Android natives AAR — identical content,
            // keep whichever arrives first.
            pickFirsts += listOf("vk/**", "mtl/**")
        }
    }
}
